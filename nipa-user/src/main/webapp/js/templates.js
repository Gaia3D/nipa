...
templates['coordinate'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<ul class=\"coordinateGroup\">\r\n    <li>\r\n        <label for=\"\">DD</label>\r\n        <input type=\"text\" value=\""
    ...
    + "\" readonly>\r\n    </li>\r\n    <li class=\"btns\">\r\n        <button type=\"button\" class=\"btnTextF move\" title=\"MoveTo\">MoveTo</button>\r\n        <button type=\"button\" class=\"btnText copy\" title=\"TextCopy\">TextCopy</button>\r\n        <button type=\"button\" class=\"btnText note\" title=\"MapNote\">MapNote</button>\r\n        <button type=\"button\" class=\"btnText delete\" title=\"Delete\">Delete</button>\r\n    </li>\r\n</ul>";
},"useData":true});
})();